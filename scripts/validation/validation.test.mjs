...
test('Application tracker stays local, portable, and free of candidate seed data', () => {
  ...
  const runtime = "const STATUSES = ['Found','Reviewing','Packet Ready','Applied','Interviewing','Offer','Closed']; localStorage.getItem(STORAGE_KEY); localStorage.setItem(STORAGE_KEY, '[]'); const payload={format:'persona-library-job-applications'}; importFile.addEventListener('change',()=>{});";
