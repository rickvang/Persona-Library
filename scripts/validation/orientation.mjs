...
export async function validateOrientation(context) {
  ...
  const operatingPackDependentRoutes = ['persona-reconciliation', 'skill-formation', 'skill-package-maintenance', 'operating-pack-reconciliation', 'playbook-composition', 'multi-persona-collaboration', 'bounded-parallel-implementation', 'template-lifecycle', 'tool-resolution', 'tool-record-maintenance', 'cross-space-reconciliation'];
