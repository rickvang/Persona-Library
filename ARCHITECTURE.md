...
- `dist/templates.html` is the Templates space: it catalogs reusable starting artifacts and scaffolds, shows purpose, applicability, source/location, status, evidence, revision, and scoped relationships without executing or rendering external artifacts.
