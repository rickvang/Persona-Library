...
For every material claim record: claim ID; original source and passage; actor/action; personal or team contribution; scope; outcome; metric meaning; dates, contract labels, and source location; uncertainty; accepted wording.
...
Start with a summary and two relevant role entries. Show what changed and how it improves the reader’s understanding while preserving meaning. Identify missing problem/decision context rather than inventing it. Keep the experience sequence reverse chronological unless a different format is explicitly chosen. Preserve month precision and legitimate repeat engagements.
...
## Review independently, then reconcile

Run separate ATS, human/narrative, visual/production, and integrity passes on the same version. Each pass reports:

| Field | Required content |
| --- | --- |
| Artifact | Exact version reviewed |
| Lens | Named persona and specific review responsibility |
...
After editing, reopen affected checks and run change-impact reconciliation over claims, chronology, duplicated or contradictory sections, links, assumptions, and status labels across the packet. A full current target description and requirement-to-evidence mapping are needed before claiming complete tailoring. Draft preparation does not authorize submission.
...
Revision 1.0 · 2026-09-07. Guidance adopted following a resume source/render audit. Reader-trial outcomes remain untested.
