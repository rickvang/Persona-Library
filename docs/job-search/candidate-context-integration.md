...
- an application tracker inside Candidate Application Context; the separate top-level Applications companion surface is governed by `application-tracker-contract.md` and keeps real rows in browser-local private state;
