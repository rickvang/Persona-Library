...
Object.assign(window.PersonaLibraryDataFragments, {
  ...
  templates: [
    ...
    },
    {
      ...
      lifecycle:'candidate',
      status:'Candidate external reference',
      source:{kind:'github_repository',repository:'rickvang/template-library',path:'templates/design-systems/web-app',entrypoint:'README.md',repositoryDocumentationEntrypoint:'README.md',revision:'560e0e5bdf3a56bcc8983a421b3112a070734023',availability:'documentation_only',verification:'Verified on 2026-09-21 against main at commit 560e0e5bdf3a56bcc8983a421b3112a070734023; templates/design-systems/web-app and its README.md entrypoint resolve, starter/ remains the copy boundary, the examples index remains outside that boundary with the source-neutral data-table candidate, and repository CONTRIBUTING.md now defines example discovery and placement across components, patterns, layouts, new Templates, and project-local work. Runtime access remains capability-dependent.'},
      provides:['semantic token starter structure','component organization','shared patterns','layout conventions','example states','source-neutral component examples'],
      ...
      operatingPacks:['operating-pack-design-system'],
      playbooks:[],
      evidence:'Verified external source evidence: templates/design-systems/web-app and its README.md entrypoint resolve in rickvang/template-library at main revision 560e0e5bdf3a56bcc8983a421b3112a070734023, with starter/ as the documented copy boundary. The examples index remains outside that boundary with the source-neutral data-table candidate, while repository CONTRIBUTING.md now documents how to discover existing examples and route new examples to components, patterns, layouts, a distinct Template, or project-local work. Persona-Library relationship evidence: Camille Ortiz applies the Component and design-system thinking Skill in the Extend and govern the design system workflow; the Design System Operating Pack provides related context without owning the starting artifact. The added routing guidance improves discoverability and maintenance process but is not user validation, repeated reuse evidence, or proof of runtime access, so the Template remains a candidate.',
      revision:{version:'0.4',date:'2026-09-21',changeType:'source-verification',summary:'Refreshed source verification after template-library added repository-level example discovery and placement guidance plus the Web App examples index; Template identity, starter boundary, example inventory, lifecycle, and applicability remain unchanged.',affectedFields:['source','evidence','revision'],confidence:'Path, README entrypoint, starter/ copy boundary, examples index, data-table candidate, and repository example-routing guidance resolve at main revision 560e0e5bdf3a56bcc8983a421b3112a070734023; the process additions do not establish repeated reuse or runtime access'}
    },
    {
