...
Object.assign(window.PersonaLibraryDataFragments, {
  ...
  templates: [
    ...
    },
    {
      ...
      lifecycle:'candidate',
      status:'Candidate external reference',
      source:{kind:'github_repository',repository:'rickvang/template-library',path:'templates/design-systems/web-app',entrypoint:'README.md',repositoryDocumentationEntrypoint:'README.md',revision:'a8ed5d946bc13efdb3011c2853309a530bf73ea3',availability:'documentation_only',verification:'Verified on 2026-09-17 against main at commit a8ed5d946bc13efdb3011c2853309a530bf73ea3; templates/design-systems/web-app and its README.md entrypoint resolve, the starter copy boundary remains present, and the examples directory includes a source-neutral data-table candidate example. Runtime access remains capability-dependent.'},
      ...
      operatingPacks:['operating-pack-design-system'],
      playbooks:[],
      evidence:'Verified external source evidence: templates/design-systems/web-app and its README.md entrypoint resolve in rickvang/template-library at main revision a8ed5d946bc13efdb3011c2853309a530bf73ea3, with starter/ as the documented copy boundary and a source-neutral data-table candidate example under examples/. Persona-Library relationship evidence: Camille Ortiz applies the Component and design-system thinking Skill in the Extend and govern the design system workflow; the Design System Operating Pack provides related context without owning the starting artifact. Repeated reuse evidence is not yet established, so the Template remains a candidate.',
      revision:{version:'0.3',date:'2026-09-17',changeType:'artifact-extension',summary:'Added and verified a source-neutral data-table candidate example outside the starter copy boundary.',affectedFields:['source','provides','evidence','revision'],confidence:'Path, entrypoint, starter boundary, and examples directory resolve at main revision a8ed5d946bc13efdb3011c2853309a530bf73ea3; the example remains a candidate reference and repeated reuse evidence is unavailable'}
    },
    {
